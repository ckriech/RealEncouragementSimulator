...
class PlayState extends FlxState {
	...
	// take duration and divide into 6 pieces
	...
	// point 0: r:100,g:0,b:0
	// take duration, divide into 6 pieces.
	// check on current position in timeline, current chunk = where we are
	// for each color,
	// if current chunk == rise, then calculate percentage of the way through chunk. se
